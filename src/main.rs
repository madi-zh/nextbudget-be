...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(budget::list_shared_budgets)
            .service(budget::get_shared_budget)
            .service(budget::create_shared_budget)
            .service(budget::update_shared_budget)
            .service(budget::update_shared_income)
            .service(budget::update_shared_savings_rate)
            .service(budget::delete_shared_budget)
            .service(budget::list_members)
            .service(budget::add_member)
            .service(budget::remove_member)
